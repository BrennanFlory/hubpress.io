webpackJsonp([2, 0], [function(e, t, a) {
    ...
    var i = a(417),
        ...
        h = function() {
            function e() {
                (0, r.default)(this, e), this.name = null, this.version = null, this.templateCache = new o.default, this.templateOptions = { data: {} }, m.default.loadCoreHelpers()
            }
            return (0, l.default)(e, [{
                key: "registerTheme",
                value: function(e, t) {
                    this.setThemeName(t.name), this.setThemeVersion(t.version), this.registerFiles(t.files);
                    var a = e.site || {};
                    a.url = e.urls.site, a.navigation = [], this.templateOptions = { data: { blog: a } }
                }
            }, {
                key: "registerFiles",
                value: function(e) {
                    var t = this;
                    console.info("Builder - registerFiles"), console.log("Builder - registerFiles", e);
                    var a = /{{!<\s+([A-Za-z0-9\._\-\/]+)\s*}}/;
                    e.forEach(function(e) {
                        if (0 === e.path.indexOf("partials/")) p.default.registerPartial(e.name, e.content);
                        else {
                            var n = { name: e.name, template: p.default.compile(e.content) },
                                i = e.content.match(a);
                            i && (n.layout = i[1]), t.templateCache.set(e.name, n)
                        }
                    })
                }
            }, {
                ...
                value: function(e, t, a) {
                    console.info("Builder - template"), console.log("Builder - template", e, t, a), v.default.set(a);
                    var n = this.templateCache.get(e),
                        i = n.template(t, this.templateOptions);
                    return n.layout && (t.body = i, n = this.templateCache.get(n.layout), i = n.template(t, this.templateOptions)), i
                }
            }, { key: "setThemeName", value: function(e) { this.name = e } }, { key: "getThemeName", value: function() { return this.name } }, { key: "getThemeVersion", value: function() { return this.version } }, { key: "setThemeVersion", value: function(e) { this.version = e } }, { key: "isTemplateAvailable", value: function(e) { return this.templateCache.get(e) } }]), e
        }();
    t.default = new h
}, , , , , , , , , , , , , function(e, t, a) {
    "use strict";
    ...
    var i = a(128),
        ...
        f = function() {
            ...
            return (0, r.default)(e, [{
                key: "generate",
                value: function(e) {
                    console.info("PaginationGenerator - generate"), console.log("PaginationGenerator - generate", e);
                    var t = e.posts,
                    ...
                    var i = 1,
                        ...
                        u = ({ name: e.opts.nextState.theme.name, version: e.opts.nextState.version, url: a.urls.theme }, a.urls, a.socialnetwork);
                    if (!t || !t.length) { var d = p.default.template(e.template, { pagination: { prev: 0, next: 0, page: 0, pages: 0, total: 0, limit: c }, posts: [], tag: e.tag, author: e.author, socialnetwork: u, title: n.title }, { config: a, theme: e.opts.nextState.theme }); return r.push({ name: "page-" + i, path: o, content: d, message: "Publish page-" + i + " " + e.template }), e.opts.nextState.elementsToPublish = (e.opts.nextState.elementsToPublish || []).concat(r), e.opts }
                    var f = Math.ceil(t.length / c);
                    return l.default.each(t, function(d, v) {
                        var h = 0,
                            x = 0;
                        i > 1 && (o = (e.path || "") + ("page/" + i + "/index.html")), i > 1 && (x = i - 1), i < f && (h = i + 1);
                        var g = void 0;
                        d.tags && (g = l.default.map(d.tags, function(e) { return { name: e, slug: (0, m.default)(e), description: null } }));
                        var b = { id: d.author.id, name: d.author.name || d.author.login, location: d.author.location, website: d.author.blog, image: d.author.avatar_url, slug: d.author.login };
                        if (s.push({ image: d.image, title: d.title, url: n.url + d.url, excerpt: d.excerpt, html: d.excerpt, tags: g, published_at: d.published_at, relativeUrl: n.url + d.url, author: b }), Math.floor((v + 1) / c) > i - 1 || v + 1 === t.length) {
                            var _ = p.default.template(e.template, { pagination: { prev: x, next: h, page: i, pages: f, total: t.length, limit: c }, context: "index" === e.template && 0 === x ? "home" : e.template, posts: s, tag: e.tag, author: e.author, title: n.title, description: n.description, socialnetwork: u, relativeUrl: "" }, { config: a, theme: e.opts.nextState.theme });
                            r.push({ name: "page-" + i, path: o, content: _, message: "Publish page-" + i + " " + e.template }), s = [], i++
                        }
                    }), e.opts.nextState.elementsToPublish = (e.opts.nextState.elementsToPublish || []).concat(r), e.opts
                }
            }]), e
        }();
    t.default = new f
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    t.CORE_LOGIN = "core:login", t.POST_DELETE = "post:delete", t.POST_GET = "post:get", t.POST_REMOTE_SAVE = "post:remote-save", t.POST_PUBLISH = "post:publish", t.POST_UNPUBLISH = "post:unpublish", t.POSTS_GET = "posts:get", t.POST_CHANGE_CONTENT = "post:change-content", t.POSTS_SYNCHRONIZE = "posts:synchronize"
}, function(e, t, a) {
    "use strict";

    function n(e, t) { return i.isPost(e) ? o.urlFor("post", { post: e, secure: e.secure }, t) : i.isTag(e) ? o.urlFor("tag", { tag: e, secure: e.secure }, t) : i.isUser(e) ? o.urlFor("author", { author: e, secure: e.secure }, t) : i.isNav(e) ? o.urlFor("nav", { nav: e, secure: e.secure }, t) : o.urlFor(e, {}, t) }
    var i = a(371).checks,
        o = a(7);
    e.exports = n
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(e, t, a) {
    ...
    function i(e) {
        e.on("application:routes", function(e) { return console.info("applicationPlugin - application:routes"), console.log("applicationPlugin - application:routes", e), e.nextState.routes.push({ path: "settings", name: "settings", component: p.default }), console.log("applicationPlugin - application:routes - return", e), e }), e.on("application:stores", function(e) {
            var t, a;
            console.info("applicationPlugin - application:stores"), console.log("applicationPlugin - application:stores", e);
            var n = {
                state: { isInitialized: !1, isFetching: !1, isLoading: !1, requireInitilisation: !1, notification: { icon: "save", header: "My Header", message: "A message", level: "default", isVisible: !1 }, routes: [], settingsTabs: [] },
                mutations: (t = {}, (0, s.default)(t, l.APPLICATION_INITIALIZE_APP, function(e, t) { _.merge(e, t.application) }), (0, s.default)(t, l.APPLICATION_INITIALIZE_PLUGINS, function(e, t) { _.merge(e, t.application) }), (0, s.default)(t, l.APPLICATION_INITIALIZE_ROUTES, function(e, t) { _.merge(e, t) }), (0, s.default)(t, l.APPLICATION_INITIALIZE_CONFIG, function(e, t) { _.merge(e, t) }), (0, s.default)(t, l.APPLICATION_PREPARE_CONFIG, function(e, t) { _.merge(e, t) }), (0, s.default)(t, l.APPLICATION_SAVE_STARTUP_CONFIG, function(e, t) { _.merge(e, t) }), (0, s.default)(t, l.APPLICATION_SAVE_CONFIG, function(e, t) { _.merge(e, t.application) }), (0, s.default)(t, l.APPLICATION_SAVE_CONFIG_DONE, function(e, t) { _.merge(e, t.application) }), (0, s.default)(t, l.APPLICATION_NOTIFY, function(e, t) { t.isVisible = !0, _.merge(e.notification, t) }), (0, s.default)(t, l.APPLICATION_CLOSE_NOTIFICATION, function(e, t) { e.notification.isVisible = !1 }), (0, s.default)(t, l.APPLICATION_LOADING, function(e, t) { e.isLoading = !0 }), (0, s.default)(t, l.APPLICATION_LOADED, function(e, t) { e.isLoading = !1 }), t),
                actions: (a = {}, (0, s.default)(a, l.APPLICATION_INITIALIZE_ROUTES, function(e) {
                    var t = e.commit,
                        a = e.rootState,
                        n = e.state,
                        i = { rootState: _.cloneDeep(a), currentState: _.cloneDeep(n) };
                    return c.default.initializeRoutes(i).then(function(e) { t(l.APPLICATION_INITIALIZE_ROUTES, e.nextState) })
                }), (0, s.default)(a, l.APPLICATION_INITIALIZE_CONFIG, function(e) {
                    var t = e.commit,
                        a = e.rootState,
                        n = e.state,
                        i = { rootState: _.cloneDeep(a), currentState: _.cloneDeep(n) };
                    return c.default.initializeConfig(i).then(function(e) { t(l.APPLICATION_INITIALIZE_CONFIG, e.nextState) })
                }), (0, s.default)(a, l.APPLICATION_INITIALIZE_APP, function(e) {
                    var t = e.commit,
                        a = e.rootState,
                        n = (e.state, { rootState: _.cloneDeep(a), currentState: _.cloneDeep(a) });
                    return c.default.initializeApp(n).then(function(e) { t(l.APPLICATION_INITIALIZE_APP, e.nextState) })
                }), (0, s.default)(a, l.APPLICATION_INITIALIZE_PLUGINS, function(e) {
                    var t = e.commit,
                        a = e.rootState,
                        n = (e.state, { rootState: _.cloneDeep(a), currentState: _.cloneDeep(a) });
                    return c.default.initializePlugins(n).then(function(e) { e.nextState.application.isInitialized = !0, t(l.APPLICATION_INITIALIZE_PLUGINS, e.nextState) })
                }), (0, s.default)(a, l.APPLICATION_PREPARE_CONFIG, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = e.state,
                        s = { rootState: _.cloneDeep(i), currentState: _.cloneDeep(o), payload: { formData: t } };
                    return s.currentState.isLoading = !0, a("application:loading").then(function(e) { return c.default.prepareConfig(s) }).then(function(e) { return n(l.APPLICATION_PREPARE_CONFIG, e.nextState), a(l.APPLICATION_SAVE_CONFIG) })
                }), (0, s.default)(a, l.APPLICATION_SAVE_STARTUP_CONFIG, function(e, t) {
                    var a = (e.dispatch, e.commit),
                        n = e.rootState,
                        i = e.state,
                        o = { rootState: _.cloneDeep(n), currentState: _.cloneDeep(i), nextState: _.cloneDeep(i) };
                    return o.nextState.config.meta.username = t.username, o.nextState.config.meta.repositoryName = t.repositoryName, o.nextState.config.meta.branch = t.branch, o.nextState.config.meta.cname = t.cname, o.nextState.requireInitilisation = !1, c.default.startUpConfig(o).then(function(e) { a(l.APPLICATION_SAVE_STARTUP_CONFIG, e.nextState) })
                }), (0, s.default)(a, l.APPLICATION_SAVE_CONFIG, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = (e.state, { rootState: _.cloneDeep(i), currentState: _.cloneDeep(i) });
                    return c.default.saveConfig(o).then(function(e) { if (n(l.APPLICATION_SAVE_CONFIG, e.nextState), !t) return a(l.APPLICATION_SAVE_CONFIG_DONE) })
                }), (0, s.default)(a, l.APPLICATION_SAVE_CONFIG_DONE, function(e) {
                    var t = e.dispatch,
                        a = e.commit,
                        n = e.rootState,
                        i = (e.state, { rootState: _.cloneDeep(n), currentState: _.cloneDeep(n) });
                    return c.default.saveConfigDone(i).then(function(e) { a(l.APPLICATION_SAVE_CONFIG_DONE, e.nextState) }).then(function(e) { return t("application:loaded") }).then(function(e) { return t("application:notify", { icon: "save", header: "Settings saved", message: "Your settings have been saved and your blog was rebuild with success. ", level: "success" }) })
                }), (0, s.default)(a, l.APPLICATION_NOTIFY, function(e, t) {
                    var a = (e.dispatch, e.commit);
                    e.rootState, e.state;
                    a(l.APPLICATION_NOTIFY, t)
                }), (0, s.default)(a, l.APPLICATION_CLOSE_NOTIFICATION, function(e) {
                    var t = (e.dispatch, e.commit);
                    e.rootState, e.state;
                    t(l.APPLICATION_CLOSE_NOTIFICATION)
                }), (0, s.default)(a, l.APPLICATION_LOADING, function(e) {
                    var t = (e.dispatch, e.commit);
                    e.rootState, e.state;
                    t(l.APPLICATION_LOADING)
                }), (0, s.default)(a, l.APPLICATION_LOADED, function(e) {
                    var t = (e.dispatch, e.commit);
                    e.rootState, e.state;
                    t(l.APPLICATION_LOADED)
                }), a),
                getters: { navigations: function(e) { return e.routes.filter(function(e) { return e.label }) } }
            };
            return e.nextState.stores.application = n, console.log("applicationPlugin - application:stores - return", e), e
        }), e.on("application:prepare-config", function(e) { return console.info("applicationPlugin - application:prepare-config"), console.log("applicationPlugin - application:prepare-config", e), e.nextState.config.meta.cname = e.payload.formData.get("application-cname"), console.log("applicationPlugin - application:prepare-config - return", e), e }), e.on("application:save-config", function(e) { return console.info("applicationPlugin - application:save-config"), console.log("applicationPlugin - application:save-config", e), console.log("applicationPlugin - application:save-config - return", e), e })
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.constants = void 0;
    var o = a(76),
        s = n(o);
    t.applicationPlugin = i;
    var r = a(335),
        c = n(r),
        l = a(126),
        u = a(795),
        p = n(u);
    t.constants = { APPLICATION_PREPARE_CONFIG: l.APPLICATION_PREPARE_CONFIG }
}, function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    t.LOGIN_LOGIN = "login:login", t.LOGIN_SUBMIT = "login:submit", t.LOGIN_UPDATE_EMAIL = "login:updateEmail", t.LOGIN_UPDATE_PASSWORD = "login:updatePassword", t.LOGIN_UPDATE_TFC = "login:updateTwoFactorCode", t.AUTHORISATION_REQUEST_LOGIN = "authorisation:request-login", t.AUTHORISATION_RECEIVE_LOGIN = "authorisation:receive-login", t.AUTHORISATION_FAILURE_LOGIN = "authorisation:failure-login", t.AUTHORISATION_AUTHENTICATION_DONE = "authorisation:authentication-done"
}, function(e, t, a) {
    "use strict";
    ...
    function n(e, t) {
        t = t || {};
        var a = e.replace(/<a href="#fn.*?rel="footnote">.*?<\/a>/gi, "");
        a = a.replace(/<div class="footnotes"><ol>.*?<\/ol><\/div>/, ""), a = a.replace(/<\/?[^>]+>/gi, ""), a = a.replace(/(\r\n|\n|\r)+/gm, " "), t.words || t.characters || (t.words = 50);
        var n = i(a, t);
        return !t.characters && n.length > 7 * t.words && (t.characters = 7 * t.words, delete t.words, n = i(a, t)), i(a, t)
    }
    var i = a(172);
    e.exports = n
}, function(e, t, a) {
    ...
    function n(e, t) {
        var a = "",
            ...
            c = "";
        return r && r.total > 1 && (c = " - Page " + r.page), a = e.meta_title ? e.meta_title : i.includes(n, "home") ? s.title : i.includes(n, "author") && e.author ? e.author.name + c + " - " + s.title : i.includes(n, "tag") && e.tag ? e.tag.meta_title || e.tag.name + c + " - " + s.title : (i.includes(n, "post") || i.includes(n, "page")) && e.post ? e.post.meta_title || e.post.title : s.title + c, (a || "").trim()
    }
    var i = a(4),
        o = a(7);
    e.exports = n
    ...
    "use strict";
    var n, i, o = a(7);
    n = function(e, t) { var a = o.url + o.paths.subdir; return void 0 !== this.tagSlug && (a += "/" + o.routeKeywords.tag + "/" + this.tagSlug), void 0 !== this.authorSlug && (a += "/" + o.routeKeywords.author + "/" + this.authorSlug), e > 1 && (a += "/" + o.routeKeywords.page + "/" + e), a += "/" }, i = function(e, t) { console.warn("warnings.helpers.page_url.isDeprecated"); var a = this; return n.call(a, e, t) }, e.exports = n, e.exports.deprecated = i
}, function(e, t, a) {
    "use strict";

    function n(e) { throw console.log(e), new Error(e) }
    var i = {},
        o = a(9),
        s = { handlebars: o };
    i.execute = function(e, t, a) { var i = s.handlebars.partials[e]; return void 0 === i ? void n("warnings.helpers.template.templateNotFound" + e) : ("string" == typeof i && (i = o.compile(i)), new s.handlebars.SafeString(i(t, a))) }, e.exports = i
}, function(e, t, a) {
    "use strict";
    ...
    function i(e, t) {
        console.info("PostGenerator - generate"), console.log("PostGenerator - generate", e);
        var a = t,
            n = (0, s.default)({}, a.original);
        n.tags = c.default.map(n.tags, function(e) { return { name: e, slug: (0, d.default)(e) } });
        var i = n.author;
        n.author = { id: i.id, name: i.name || i.login, location: i.location, website: i.blog, image: i.avatar_url, bio: i.bio, status: "", slug: i.login };
        var o = e.rootState.application.config,
            r = o.urls;
        ({ name: e.nextState.theme.name, version: e.nextState.theme.version, url: o.urls.theme });
        n.urls = r, n.status = "published";
        var l = u.default.template("post", { context: "post", socialnetwork: o.socialnetwork, relativeUrl: a.url, post: n, author: n.author }, { config: o, theme: e.nextState.theme }),
            p = [];
        return p.push({ title: a.title, image: a.image, name: a.name, path: o.urls.getPostGhPath(a.name), url: o.urls.getPostGhPath(a.name), content: l, message: "Publish " + a.name, published_at: a.published_at }), e.nextState.elementsToPublish = (e.nextState.elementsToPublish || []).concat(p), e
    }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var o = a(19),
        s = n(o);
    ...
    var v = a(19),
        ...
        x = a(52),
        g = n(x);
    t.default = { initializeRoutes: i, initializeApp: m, initializePlugins: f, initializeConfig: c, startUpConfig: l, prepareConfig: u, saveConfig: p, saveConfigDone: d }
}, function(e, t, a) {
    "use strict";
    ...
    function o(e) {
        e.on("application:stores", function(e) {
            var t;
            console.info("authenticationPlugin - application:stores"), console.log("authenticationPlugin - application:stores", e);
            var a = {
                state: { isAuthenticated: !1, isTwoFactorCodeRequired: !1, credentials: { email: void 0, password: void 0, twoFactorCode: void 0 } },
                mutations: (t = {}, (0, r.default)(t, v.LOGIN_UPDATE_EMAIL, function(e, t) { e.credentials.email = t }), (0, r.default)(t, v.LOGIN_UPDATE_PASSWORD, function(e, t) { e.credentials.password = t }), (0, r.default)(t, v.LOGIN_UPDATE_TFC, function(e, t) { e.credentials.twoFactorCode = t }), (0, r.default)(t, v.AUTHORISATION_REQUEST_LOGIN, function(e) { e.isLoading = !0 }), (0, r.default)(t, v.AUTHORISATION_RECEIVE_LOGIN, function(e, t) { l.default.merge(e, t) }), (0, r.default)(t, v.AUTHORISATION_FAILURE_LOGIN, function(e, t) { e.isAuthenticated = !1 }), (0, r.default)(t, h, function(e, t) { l.default.merge(e, t.authentication) }), t),
                actions: (0, r.default)({}, v.LOGIN_SUBMIT, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = e.state;
                    n(v.AUTHORISATION_REQUEST_LOGIN);
                    var s = { rootState: l.default.cloneDeep(i), currentState: l.default.cloneDeep(o) };
                    a("application:loading").then(function(e) { return p.default.authenticate(s) }).then(function(e) { n(v.AUTHORISATION_RECEIVE_LOGIN, e.nextState) }).then(function(e) { if (o.isAuthenticated) { var t = !0; return a(x, t).then(function(e) { a(v.AUTHORISATION_AUTHENTICATION_DONE) }) } return o.isTwoFactorCodeRequired ? a("application:notify", { icon: "unlock", header: "Two factor code", message: "A code is required to complete your authentication.", level: "warning" }) : e }).then(function(e) { return a("application:loaded") }).then(function(e) { return t.push(t.currentRoute.query.redirect || "/") }).catch(function(e) { a("application:loaded").then(function(e) { return a("application:notify", { icon: "warning circle", header: "Authentication failed", message: "A error occured during the authentication.", level: "error" }) }) })
                }),
                getters: {}
            };
            return e.nextState.stores.authentication = a, console.log("authenticationPlugin - application:stores - return", e), e
        }), e.on("application:routes", function(e) { return e }), e.on("application:initialize-app", function(e) { return console.info("authenticationPlugin - application:initialize-app"), console.log("authenticationPlugin - application:initialize-app", e), p.default.initialize(e).then(function(t) { return e }) }), e.on("authentication:authenticate", function(e) { return console.info("authenticationPlugin - authentication:authenticate"), console.log("authenticationPlugin - authentication:authenticate", e, p.default), p.default.authenticate(e) })
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.LoginComponent = void 0;
    var s = a(76),
        r = i(s);
    t.authenticationPlugin = o;
    var c = a(4),
        l = i(c),
        u = a(337),
        p = i(u),
    ...
    var u = a(52),
        p = n(u);
    t.default = { authenticate: l, initialize: c }
}, function(e, t, a) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.dashboardPlugin = i;
    var o = a(797),
        s = n(o)
}, function(e, t, a) {
    "use strict";
    ...
    function o(e, t) {
        var a = b.hash({ doctype: "article", backend: "html5", safe: "unsafe", attributes: ["showtitle!", "allow-uri-read", "imagesdir=" + e.urls.site + "/images", "icons=font"] }),
            ...
            c = _.$load(s.full, a),
            l = { attributes: m.default.pick(c.attributes, ["$$smap"]), excerpt: r.$convert(), html: c.$convert() };
        return l
    }
    ...
    function r(e) {
        e.on("hubpress:request-rendering-documents", function(e) {
            console.info("Asciidoc Plugin - hubpress:request-rendering-documents"), console.log("hubpress:request-rendering-documents", e);
            var t = e.rootState.application.config,
                a = (e.nextState.posts || []).map(function(e) {
                    var a = (0, l.default)({}, e, o(t, e.content), { content: e.content }),
                        n = m.default.pick(a, "attributes", "author", "html", "tags", "content", "name", "path", "sha");
                    a.title = n.title = n.attributes.$$smap.doctitle, a.image = n.image = n.attributes.$$smap["hp-image"], a.tags = n.tags = s(n.attributes), a.url = n.url = t.urls.getPostUrl(n.name);
                    var i = (0, l.default)({}, a, { original: n });
                    return i.original.published_at = i.published_at = n.name.split("-").slice(0, 3).join("-"), i
                });
            return e.nextState.posts = a, e
        }), e.on("requestRenderingPost", function(e) {
            console.info("Asciidoc Plugin - requestRenderingPost"), console.log("requestRenderingPost", e);
            var t = o(e.rootState.application.config, e.nextState.post.content);
            e.nextState.post = (0, l.default)({}, e.nextState.post, t), e.nextState.post.title = t.attributes.$$smap.doctitle, e.nextState.post.image = t.attributes.$$smap["hp-image"], e.nextState.post.tags = s(t.attributes), e.nextState.post.published_at = t.attributes.$$smap.published_at || e.nextState.post.published_at || (0, v.default)().format("YYYY-MM-DD");
            var a = t.attributes.$$smap["hp-alt-title"];
            return e.nextState.post.name = (0, x.default)(e.nextState.post.published_at + "-" + (a || e.nextState.post.title)) + ".adoc", e.nextState.post.url = e.rootState.application.config.urls.getPostUrl(e.nextState.post.name), e
        })
    }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var c = a(19),
    ...
    (function(e) {
        ...
        ! function(s) { "object" == (0, c.default)(t) && "object" == (0, c.default)(e) ? s(a(1)): "object" == ("undefined" == typeof brackets ? "undefined" : (0, c.default)(brackets)) && brackets.getModule ? s(brackets.getModule("thirdparty/CodeMirror2/lib/codemirror")) : (i = [a(1)], n = s, o = "function" == typeof n ? n.apply(t, i) : n, !(void 0 !== o && (e.exports = o))) }(function(e) {
            e.defineMode("asciidoc", function(e, t) {
                var a = function() {
                    ...
                    i = function(e) {
                        ...
                        for (var t in this.states) {
                            for (var a = this.states[t], n = [], i = 0, o = this.matchMappings[t] = { defaultToken: "text" }, s = "g", r = [], c = 0; c < a.length; c++) {
                                var l = a[c];
                                if (l.defaultToken && (o.defaultToken = l.defaultToken), l.caseInsensitive && (s = "gi"), null != l.regex) {
                                    ...
                                    var u = l.regex,
                                        p = new RegExp("(?:(" + u + ")|(.))").exec("a").length - 2;
                                    if (Array.isArray(l.token))
                                        if (1 == l.token.length || 1 == p) l.token = l.token[0];
                                        else {
                                            if (p - 1 != l.token.length) throw new Error("number of classes and regexp groups in '" + l.token + "'\n'" + l.regex + "' doesn't match\n" + (p - 1) + "!=" + l.token.length);
                ...
                (function() {
                    this.$setMaxTokenCount = function(e) { n = 0 | e }, this.$applyToken = function(e) {
                        var t = this.splitRegex.exec(e).slice(1),
                            a = this.token.apply(this, t);
                        if ("string" == typeof a) return [{ type: a, value: e }];
                        for (var n = [], i = 0, o = a.length; i < o; i++) t[i] && (n[n.length] = { type: a[i], value: t[i] });
                        return n
                    }, this.$arrayTokens = function(e) { if (!e) return []; var t = this.splitRegex.exec(e); if (!t) return "text"; for (var a = [], n = this.tokenArray, i = 0, o = n.length; i < o; i++) t[i + 1] && (a[a.length] = { type: n[i], value: t[i + 1] }); return a }, this.removeCapturingGroups = function(e) { var t = e.replace(/\[(?:\\.|[^\]])*?\]|\\.|\(\?[:=!]|(\()/g, function(e, t) { return t ? "(?:" : e }); return t }, this.createSplitterRegexp = function(e, t) {
                        if (e.indexOf("(?=") != -1) {
                            var a = 0,
                                n = !1,
                                i = {};
                            e.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g, function(e, t, o, s, r, c) { return n ? n = "]" != r : r ? n = !0 : s ? (a == i.stack && (i.end = c + 1, i.stack = -1), a--) : o && (a++, 1 != o.length && (i.stack = a, i.start = c)), e }), null != i.end && /^\)*$/.test(e.substr(i.end)) && (e = e.substring(0, i.start) + e.substr(i.end))
                        }
                        ...
                        var s = this.matchMappings[i],
                            r = this.regExps[i];
                        r.lastIndex = 0;
                        for (var c, l = [], u = 0, p = { type: null, value: "" }; c = r.exec(e);) {
                            var d = s.defaultToken,
                                m = null,
                                f = c[0],
                                v = r.lastIndex;
                            if (v - f.length > u) {
                                var h = e.substring(u, v - f.length);
                                p.type == d ? p.value += h : (p.type && l.push(p), p = { type: d, value: h })
                            }
                            for (var x = 0; x < c.length - 2; x++)
                ...
                var o = { empty: null, text: null, keyword: "keyword", control: "keyword", operator: "operator", constant: "atom", numeric: "number", character: "atom", escape: "atom", variable: "variable", parameter: "variable-3", language: "variable-2", comment: "comment", line: "comment", "double-slash": "comment", "double-dash": "comment", "number-sign": "comment", percentage: "comment", block: "comment", doc: "comment", string: "string", quoted: "string", single: "string", double: "string", triple: "string", unquoted: "string", interpolated: "string", regexp: "string-2", meta: "keyword", literal: "qualifier", support: "builtin", markup: "tag", underline: "link", link: "link", strong: "strong", heading: "header", heading2: "header-2", heading3: "header-3", heading4: "header-4", heading5: "header-5", heading6: "header-6", em: "em", list: "variable-2", numbered: "variable-2", unnumbered: "variable-2", quote: "quote", raw: "variable-2", invalid: "error", illegal: "invalidchar", deprecated: "error" },
                    ...
                    c = function(e, t) {
                        ...
                        var a = t.current,
                            n = e.match(/.*$/, !1)[0],
                            i = u.getLineTokens(n, a);
                        return t.plannedTokens = i.tokens, t.current = i.state, r(e, t)
                    },
                    l = new a,
                    u = new i(l.$rules);
                return { startState: function() { return { current: "start", plannedTokens: [] } }, blankLine: function(e) { c("", e) }, token: c }
    ...
    function i(e) {
        e.on("application:stores", function(e) {
            var t, a;
            console.info("hubpressPlugin - application:stores"), console.log("hubpressPlugin - application:stores", e);
            var n = {
                state: { post: {}, posts: [], theme: {} },
                mutations: (t = {}, (0, c.default)(t, I, function(e, t) { console.log("hubpress-" + I, t), u.default.merge(e, t.hubpress) }), (0, c.default)(t, T, function(e, t) { console.log("hubpress-" + T, t), u.default.merge(e, t) }), (0, c.default)(t, p.POSTS_GET, function(e, t) { console.log(p.POSTS_GET, t), e.posts = t.posts }), (0, c.default)(t, p.POST_GET, function(e, t) { t.post.content || (t.post.content = "// = Your Blog title\n// See https://hubpress.gitbooks.io/hubpress-knowledgebase/content/ for information about the parameters.\n// :hp-image: /covers/cover.png\n// :published_at: 2019-01-31\n// :hp-tags: HubPress, Blog, Open_Source,\n// :hp-alt-title: My English Title\n"), e.post = t.post }), (0, c.default)(t, p.POST_REMOTE_SAVE, function(e, t) { console.log(p.POST_REMOTE_SAVE, t), u.default.merge(e, t) }), (0, c.default)(t, p.POST_PUBLISH, function(e, t) { console.log(p.POST_PUBLISH, t), u.default.merge(e, t) }), (0, c.default)(t, p.POST_UNPUBLISH, function(e, t) { console.log(p.POST_UNPUBLISH, t), u.default.merge(e, t) }), (0, c.default)(t, p.POSTS_SYNCHRONIZE, function(e, t) { console.log(p.POSTS_SYNCHRONIZE, t), u.default.merge(e, t), e.posts = t.posts }), (0, c.default)(t, p.POST_CHANGE_CONTENT, function(e, t) { console.log("Content Changed", t), e.post = t.post }), (0, c.default)(t, p.POST_DELETE, function(e, t) { console.log("Post deleted", t), u.default.merge(e, t), e.posts = t.posts }), t),
                actions: (a = {}, (0, c.default)(a, A, function(e) {
                    var t = (e.dispatch, e.commit),
                        a = e.rootState,
                        n = e.state,
                        i = { rootState: u.default.cloneDeep(a), currentState: u.default.cloneDeep(n) };
                    return m.default.initialize(i).then(function(e) { return t(T, e.nextState) }).then(function(e) { return console.info("HubPress initialized and synchronized") })
                }), (0, c.default)(a, p.POSTS_SYNCHRONIZE, function(e) {
                    var t = e.dispatch,
                        a = e.commit,
                        n = e.rootState,
                        i = e.state,
                        o = { rootState: u.default.cloneDeep(n), currentState: u.default.cloneDeep(i) };
                    return t("application:loading").then(function(e) { return m.default.synchronize(o) }).then(function(e) { return a(p.POSTS_SYNCHRONIZE, e.nextState) }).then(function(e) { return t("application:loaded") }).then(function(e) { return t("application:notify", { icon: "refresh", header: "Synchronization", message: "Your content has been synchronized with success.", level: "success" }) })
                }), (0, c.default)(a, p.POST_GET, function(e, t) {
                    var a = (e.dispatch, e.commit),
                        n = e.rootState,
                        i = e.state;
                    console.log(p.POST_GET, t);
                    var o = { rootState: u.default.cloneDeep(n), currentState: u.default.cloneDeep(i), nextState: u.default.cloneDeep(i) };
                    return o.nextState.post._id = t, m.default.getLocalPost(o).then(function(e) { return a(p.POST_GET, e.nextState) })
                }), (0, c.default)(a, p.POST_DELETE, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = e.state;
                    console.log(p.POST_DELETE, t);
                    var s = { rootState: u.default.cloneDeep(i), currentState: u.default.cloneDeep(o), nextState: u.default.cloneDeep(o) };
                    return s.nextState.post = { _id: t }, a("application:loading").then(function(e) { return m.default.deletePost(s) }).then(function(e) { return n(p.POST_DELETE, e.nextState) }).then(function(e) { return a("application:loaded") }).then(function(e) { return a("application:notify", { icon: "trash", header: "Post deleted", message: "Your post has been deleted with success.", level: "success" }) })
                }), (0, c.default)(a, p.POST_REMOTE_SAVE, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = e.state;
                    console.log(p.POST_REMOTE_SAVE, t);
                    var s = { rootState: u.default.cloneDeep(i), currentState: u.default.cloneDeep(o) };
                    return a("application:loading").then(function(e) { return m.default.remoteSavePost(s) }).then(function(e) { return n(p.POST_REMOTE_SAVE, e.nextState) }).then(function(e) { return a("application:loaded") }).then(function(e) { return a("application:notify", { icon: "save", header: "Post saved", message: "Your post has been saved remotely with success.", level: "success" }) })
                }), (0, c.default)(a, p.POST_PUBLISH, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = e.state;
                    console.log(p.POST_PUBLISH, t);
                    var s = { rootState: u.default.cloneDeep(i), currentState: u.default.cloneDeep(o) };
                    return a("application:loading").then(function(e) { return m.default.publishPost(s) }).then(function(e) { return n(p.POST_PUBLISH, e.nextState) }).then(function(e) { return a("application:loaded") }).then(function(e) { return a("application:notify", { icon: "rocket", header: "Post published", message: "Your post has been published with success.", level: "success" }) })
                }), (0, c.default)(a, p.POST_UNPUBLISH, function(e, t) {
                    var a = e.dispatch,
                        n = e.commit,
                        i = e.rootState,
                        o = e.state,
                        s = { rootState: u.default.cloneDeep(i), currentState: u.default.cloneDeep(o) };
                    return a("application:loading").then(function(e) { return m.default.unpublishPost(s) }).then(function(e) { return n(p.POST_UNPUBLISH, e.nextState) }).then(function(e) { return a("application:loaded") }).then(function(e) { return a("application:notify", { icon: "check circle", header: "Post unpublished", message: "Your post has been unpublished with success.", level: "success" }) })
                }), (0, c.default)(a, p.POSTS_GET, function(e) {
                    var t = e.dispatch,
                        a = e.commit,
                        n = e.rootState,
                        i = e.state;
                    console.log(p.POSTS_GET);
                    var o = { rootState: u.default.cloneDeep(n), currentState: u.default.cloneDeep(i) };
                    return t("application:loading").then(function(e) { return m.default.getLocalPosts(o) }).then(function(e) { return a(p.POSTS_GET, e.nextState) }).then(function(e) { return t("application:loaded") })
                }), (0, c.default)(a, p.POST_CHANGE_CONTENT, function(e, t) {
                    var a = (e.dispatch, e.commit),
                        n = e.rootState,
                        i = e.state,
                        o = { rootState: u.default.cloneDeep(n), currentState: u.default.cloneDeep(i), payload: { post: t } };
                    return m.default.renderAndSavePost(o).then(function(e) { a(p.POST_CHANGE_CONTENT, e.nextState) })
                }), a),
                getters: {}
            };
            return e.nextState.stores.hubpress = n, console.log("hubpressPlugin - application:stores - return", e), e
    ...
    var I = "application:initialize-plugins",
        T = "hubpress:initialize",
        A = "authorisation:authentication-done"
}, function(e, t, a) {
    "use strict";
    ...
    var i = a(130),
        ...
        d = a(347),
        m = n(d);
    t.default = (0, o.default)({}, r.default, l.default, p.default, m.default)
}, function(e, t, a) {
    "use strict";
    ...
    var s = a(57),
        ...
        c = a(2),
        l = n(c);
    t.default = { initialize: i, synchronize: o }
}, function(e, t, a) {
    "use strict";
    ...
    var p = a(57),
        d = n(p);
    t.default = { deletePost: u, getLocalPost: i, getLocalPosts: o, remoteSavePost: r, renderAndSavePost: s, publishPost: c, unpublishPost: l }
}, function(e, t, a) {
    "use strict";
    ...
    var o = a(57),
        s = n(o);
    t.default = { refreshAfterSavedConfig: i }
}, function(e, t, a) {
    "use strict";
    ...
    function o(e) {
        var t = M.default.defer();
        console.log("getAuthorizations", e);
        var a = {};
        return e.listAuthorizations(a, function(e, a) { e ? t.reject(e) : (console.log("getAuthorizations list", a), t.resolve(a)) }), t.promise
    }
    ...
    function c(e, t, a) {
        ...
        return t.forEach(function(e) {
            var t = e.note;
            t === o && (i = e.id)
        }), i !== -1 ? a.deleteAuthorization(i, function(e, t) {
            e ? n.reject(e) : n.resolve()
        }) : n.resolve(), n.promise
    }

    function l(e, t) {
        var a = M.default.defer(),
            n = { scopes: ["public_repo"], note: r(e) };
        return t.createAuthorization(n, function(e, t) { e ? a.reject(e) : a.resolve(t) }), a.promise
    }
    ...
    function u(e) {
        ...
        Q = new z.default({ auth: "basic", username: a.email, password: a.password, twoFactorCode: a.twoFactorCode });
        var r = Q.getRepo(n.username, n.repositoryName),
            u = Q.getAuthorization(),
            p = Q.getUser(),
            d = void 0,
            m = void 0;
        return i(r).then(function(e) { d = e }).then(s(p)).then(function(e) { return m = e, o(u) }).then(function(e) { return c(n.repositoryName, e, u) }).then(function() { return l(n.repositoryName, u) }).then(function(e) { Q = new z.default({ auth: "oauth", token: e.token }), t.resolve({ isAuthenticated: !0, credentials: { token: e.token }, permissions: d.permissions, userInformations: m }) }).catch(function(e) {
            console.error("githubPlugin - login error", e, e.response);
            var a, i = { type: "error", title: "Authentication" };
            if (e.response) {
                var o = e.response.headers && e.response.headers["x-github-otp"] || "";
    ...
    function p(e, t) {
        var a = M.default.defer();
        return e.getContents(t.meta.branch, "", !0, function(e, t) {
            if (e) a.reject(e);
            else {
                var n = void 0;
                t.forEach(function(e) { "_posts" === e.name && (n = e.sha) }), a.resolve(n)
            }
        }), a.promise
    }
    ...
    function d(e, t, a) {
        var n = void 0;
        if (a === localStorage.postsSha) n = M.default.fcall(function() { return [] });
        else {
            var i = M.default.defer();
            e.getContents(t.meta.branch, "_posts", !0, function(e, t) { e ? i.reject(e) : i.resolve(t) }), n = i.promise
        }
        return n
    }
    ...
    function m(e, t) {
        ...
        return i.getSha(e.meta.branch, e.urls.getPostGhPath(t.name), function(e, n) {
            if (e && e.response && 404 !== e.response.status) a.reject(e);
            else {
                var i = n ? 1 : 0,
    ...
    function f(e, t, a) {
        var n = U.default.compact(a),
            i = n.map(function(e) { return m(t, e) });
        return M.default.all(i)
    }
    ...
    function v(e, t, a) {
        ...
        return console.log("getPostAuthor", t), o.listCommits({ sha: e.meta.branch, path: t.original && t.original.path || t.path }, function(e, i) {
            if (e && 404 !== e.error) n.reject(e);
            else {
                var o = i[i.length - 1].author;
                if (o && o.login !== a.login) {
                    var r = Q.getUser(o.login);
                    s(r)().then(function(e) {
                        o = (0, A.default)({}, e);
                        var a = (0, A.default)({}, t, { author: o });
                        n.resolve(a)
                    }).catch(function(e) { return n.reject(e) })
                } else {
                    o = (0, A.default)({}, a);
                    var c = (0, A.default)({}, t, { author: o });
                    n.resolve(c)
                }
            }
        }), n.promise
    ...
    function x(e, t, a) {
        ...
        return a.forEach(function(a) {
            var i = M.default.defer();
            n.push(i.promise), e.getContents(t.meta.branch, a.path, !0, function(e, t) {
                if (e) i.reject(e);
                else {
                    var n = void 0;
                    n = (0, A.default)({}, a, { content: t }), i.resolve(n)
                }
            })
        }), M.default.all(n)
    }
    ...
    function g(e) {
        ...
        return p(n, t).then(function(e) { return d(n, t, e) }).then(function(e) { return e.map(function(e) { return U.default.pick(e, ["name", "path", "sha", "size"]) }) }).then(function(e) { return f(n, t, e) }).then(function(a) { return h(n, t, a, e.authentication.userInformations) }).then(function(e) { return x(n, t, e) })
    }
    ...
    function P(e, t) {
        ...
        if (t.original && t.name !== t.original.name) {
            var o = M.default.defer();
            i = o.promise;
            var s = e.meta.branch,
                r = "_posts/" + t.original.name,
                c = "_posts/" + t.name;
            n.move(s, r, c, function(a, i) {
                if (a) o.reject(a);
                else if (t.published) {
                    var r = e.urls.getPostGhPath(t.original.name);
                    _(n, s, r).then(function(e) { o.resolve({ post: t, sha: e }) }).catch(function(e) { o.reject(e) }).done()
                } else o.resolve({ post: t, sha: i })
            })
        } else i = (0, M.default)({ post: t });
        return i
    }
    ...
    function k(e, t) {
        ...
        var a = e.meta,
            ...
            s = "Update " + t.name,
            r = M.default.defer();
        return n.writeFile(i, o, t.content, s, function(a, n) { a ? r.reject(a) : (t.original = U.default.omit(t, ["original"]), t.original.url = e.urls.getPostUrl(t.original.name), t.original.path = "_posts/" + t.original.name, t.original.sha = n, J = n.commit, console.info("Update lastCacheCommit", J), r.resolve(t)) }), r.promise
    }
    ...
    function y(e) {
        ...
        var t = M.default.defer(),
            ...
            n = Q.getRepo(a.username, a.repositoryName),
            i = a.branch;
        return n.writeFile(i, "hubpress/config.json", (0, I.default)(e, null, 2), "Update configuration file", function(e, a) { e ? t.reject(e) : (J = a.commit, console.info("Update lastCacheCommit", J), t.resolve(a)) }), t.promise
    }
    ...
    function j(e) {
        e.on("application:request-config", function(e) { return console.info("githubPlugin - application:request-config"), console.log("githubPlugin - application:request-config", e), (0, L.default)("config.json?dt=" + Date.now()).then(function(e) { return e.json() }).then(function(t) { return e.nextState.config = (0, A.default)({}, e.nextState.config, t), e.nextState.config.theme.name = e.nextState.config.theme.name.toLowerCase(), e }) }), e.on("application:receive-config", function(e) { console.info("githubPlugin - application:receive-config"), console.log("githubPlugin - application:receive-config", e); var t = (0, V.default)(e.nextState.config); return e.nextState.config = (0, A.default)({}, e.nextState.config, { urls: t }), e }), e.on("requestAuthentication", function(e) { return console.info("githubPlugin - requestAuthentication"), console.log("githubPlugin - requestAuthentication", e), u(e).then(function(t) { var a = (0, A.default)({}, e.nextState.credentials, t.credentials); return e.nextState = (0, A.default)({}, e.nextState, t, { credentials: a }), e }) }), e.on("receiveSavedAuth", function(e) { return console.info("githubPlugin - receiveSavedAuth"), console.log("githubPlugin - receiveSavedAuth", e), e.nextState.authentication.isAuthenticated && (Q = new z.default({ auth: "oauth", token: e.nextState.authentication.credentials.token })), e }), e.on("hubpress:request-remote-synchronization", function(e) { return console.info("githubPlugin - hubpress:request-remote-synchronization"), console.log("githubPlugin - hubpress:request-remote-synchronization", e), e.rootState.authentication.isAuthenticated ? g(e.rootState).then(function(t) { return e.nextState = (0, A.default)({}, e.nextState, { posts: t }), e }) : e }), e.on("requestSaveRemotePost", function(e) {
            ...
            var o = M.default.defer();
            return a.getBranch(t.branch, function(s, r) {
                if (s) { var c = M.default.defer(); return o = c.promise, c.reject(s) }
                var l = 0,
                    u = i.reduce(function(e, i) {
                        var o = function(e) {
                            var o = M.default.defer(),
                                s = i.map(function(e) { return { path: e.path, mode: "100644", type: "blob", content: e.content } });
                            return a.createTree(s, e, function(s, r) { return s ? o.reject(s) : void a.commit(e, r.sha, "Published " + (l + i.length) + "/" + n + " elements", function(e, n) { return e ? o.reject(e) : (l += i.length, J = n, void a.updateHead("heads/" + t.branch, n.sha, !1, function(e, t) { return console.log("updateHead", e, t), e ? o.reject(e) : void o.resolve(n.sha) })) }) }), o.promise
                        };
                        return e.then(o)
                    }, (0, M.default)(S({ committer: r.commit.commit.committer, sha: r.commit.sha }, J)));
                u.then(function(t) { o.resolve(e) }).catch(function(e) { o.reject(e) })
            }), o.promise
        }), e.on("requestDeleteRemotePost", function(e) {
            console.info("githubPlugin - requestDeleteRemotePost"), console.log("githubPlugin - requestDeleteRemotePost", e);
            var t = M.default.defer(),
                a = e.rootState.application.config,
                n = a.meta,
                i = Q.getRepo(n.username, n.repositoryName),
                o = e.nextState.post.original.path;
            return i.deleteFile(n.branch, o, function(a, n) { a && a.response && 404 !== a.response.status ? t.reject(a) : t.resolve(e) }).catch(function(a) { a && a.response && 404 === a.response.status && t.resolve(e) }), t.promise
        }), e.on("requestDeleteRemotePublishedPost", function(e) {
            console.info("githubPlugin - requestDeleteRemotePublishedPost"), console.log("githubPlugin - requestDeleteRemotePublishedPost", e);
            var t = M.default.defer(),
                a = e.rootState.application.config,
                n = a.meta,
                i = Q.getRepo(n.username, n.repositoryName),
                o = a.urls.getPostGhPath(e.nextState.post.original.name);
            return i.deleteFile(n.branch, o, function(a, n) { a ? t.reject(a) : t.resolve(e) }), t.promise
        }), e.on("application:request-save-config", function(e) { console.info("githubPlugin - application:request-save-config"), console.log("githubPlugin - application:request-save-config", e); var t = e.nextState.application; return y(t.config).then(function(e) { return w(t.config) }).then(function(t) { return e }) }), e.on("receiveRenderingPost", function(e) { return console.info("githubPlugin - receiveRenderingPost"), console.log("githubPlugin - receiveRenderingPost", e), e }), e.on("application:initialize-plugins", function(e) { console.info("githubPlugin - application:initialize-plugins"), console.log("githubPlugin - application:initialize-plugins", e); var t = "put your repository name here" === e.rootState.application.config.meta.repositoryName || "put your username here" === e.rootState.application.config.meta.username; return e.nextState.application.requireInitilisation = t, e.nextState.application.config.initialisationConfigComponent = Z.default, e })
    }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var C = a(75),
        I = n(C),
    ...
    function i(e) {
        e.on("hubpress:request-local-synchronization", function(e) {
            console.info("pouchDbPlugin - hubpress:request-local-synchronization"), console.log("pouchDbPlugin - hubpress:request-local-synchronization", e);
            var t = e.nextState.posts || [],
                a = t.map(function(e) {
                    return function() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                            a = c.default.defer();
                        return delete e._links, g.find({ selector: { type: { $eq: x }, "original.name": { $eq: e.name } }, limit: 1 }).then(function(n) {
                            if (console.log("POST find values", n), n.docs.length) {
                                console.log("pouchDbPlugin - post found", e.name);
                                var i = n.docs[0];
                                i.original && i.original.content !== e.content || i.published !== e.published ? (console.log("pouchDbPlugin - post have changed", e.name), e._id = i._id, e._rev = i._rev, e.type = x, g.put(e).then(function() { e._rev = i._rev, t.push(e), a.resolve(t) }).catch(function(e) { a.reject(e) })) : (console.log("pouchDbPlugin - post have not changed", e.name), e._id = i._id, e._rev = i._rev, e.type = x, t.push(e), a.resolve(t))
                            } else console.log("pouchDbPlugin - post not found", e.name), e._id = d.default.v4(), e.type = x, g.put(e).then(function(n) { e._rev = n.rev, t.push(e), a.resolve(t) }).catch(function(e) { a.reject(e) })
                        }), a.promise
                    }
                }),
                n = (a || []).reduce(function(e, t) { return e.then(t) }, (0, c.default)([])),
                i = t.map(function(e) { return e.name }),
                o = g.find({ selector: { type: { $eq: x }, "original.name": { $nin: i } } }).then(function(e) { if (e.docs.length) { var t = e.docs.map(function(e) { return u.default.pick(e, ["_id", "_rev", "attributes", "content", "excerpt", "html", "name", "path", "title", "type", "url"]) }); return g.bulkDocs(t) } return [] });
            return o.then(function() { return n }).then(function(t) { return e.nextState.posts = t, e })
        }), e.on("application:receive-config", function(e) { return console.info("pouchDbPlugin - application:receive-config"), console.log("pouchDbPlugin - application:receive-config", e), g ? e : (g = new f.default("hubpress-" + e.nextState.config.meta.username + "-" + e.nextState.config.meta.repositoryName), g.info().then(function(e) { console.log("PouchDB infos", e) }), g.createIndex({ index: { fields: ["name", "type"] } }).then(function() { return g.createIndex({ index: { fields: ["type"] } }) }).then(function() { return g.createIndex({ index: { fields: ["original.name", "type"] } }) }).then(function() { return g.createIndex({ index: { fields: ["published", "type"] } }) }).then(function() { return g.createIndex({ index: { fields: ["original.name", "published", "type"] } }) }).then(function() { return e })) }), e.on("hubpress:request-local-posts", function(e) { return console.info("pouchDbPlugin - hubpress:request-local-posts"), console.log("pouchDbPlugin - hubpress:request-local-posts", e), g.find({ selector: { name: { $gt: null }, type: { $eq: x } }, sort: [{ name: "desc" }] }).then(function(t) { return e.nextState = (0, s.default)({}, e.nextState, { posts: t.docs }), e }) }), e.on("requestSelectedPost", function(e) { return console.info("pouchDbPlugin - requestSelectedPost"), console.log("pouchDbPlugin - requestSelectedPost", e), g.get(e.data.post._id).then(function(t) { var a = (0, s.default)({}, e.data, { selectedPost: t }); return (0, s.default)({}, e, { data: a }) }) }), e.on("hubpress:request-local-post", function(e) { console.info("pouchDbPlugin - hubpress:request-local-post"), console.log("pouchDbPlugin - hubpress:request-local-post", e); var t = c.default.defer(); return g.get(e.nextState.post._id).then(function(a) { e.nextState = (0, s.default)({}, e.nextState, { post: a }), t.resolve(e) }).catch(function(a) { 404 === a.status ? (e.nextState = (0, s.default)({}, e.nextState, { post: { _id: e.nextState.post._id } }), t.resolve(e)) : t.reject(a) }), t.promise }), e.on("requestSaveLocalPost", function(e) {
            console.info("pouchDbPlugin - requestSaveLocalPost"), console.log("pouchDbPlugin - requestSaveLocalPost", e);
            var t = c.default.defer();
            return g.find({ selector: { _id: { $ne: e.nextState.post._id }, name: { $eq: e.nextState.post.name }, type: { $eq: x } }, limit: 1 }).then(function(t) { if (t.docs.length) throw new Error("Post with the name " + e.nextState.post.name + " already exist"); return e.nextState.post._id }).then(function(e) { return g.get(e) }).then(function(a) {
                var n = (0, s.default)({}, a, e.nextState.post);
                n._rev = a._rev, n.type = x, g.put(n).then(function(a) { n._rev = a.rev, e.nextState.post = n, t.resolve(e) }).catch(function(e) { return t.reject(e) })
            }).catch(function(a) {
                if (404 === a.status) {
                    var n = e.nextState.post;
                    g.put(n).then(function(a) { n._rev = a.rev, e.nextState.post = n, t.resolve(e) }).catch(function(e) { return t.reject(e) })
                } else t.reject(a)
            }), t.promise
        }), e.on("requestLocalPublishedPosts", function(e) { return console.info("pouchDbPlugin - requestLocalPublishedPosts"), console.log("pouchDbPlugin - requestLocalPublishedPosts", e), g.find({ selector: { "original.name": { $gt: null }, published: { $eq: 1 }, type: { $eq: x } }, sort: [{ "original.name": "desc" }] }).then(function(t) { return console.log("requestLocalPublishedPosts => ", t), e.nextState.publishedPosts = t.docs, e }) }), e.on("requestDeleteLocalPost", function(e) { return console.info("pouchDbPlugin - requestDeleteLocalPost"), console.log("pouchDbPlugin - requestDeleteLocalPost", e), g.remove(e.nextState.post._id, e.nextState.post._rev).then(function() { return e }) })
    }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var o = a(19),
        s = n(o);
    ...
    var r = a(107),
        ...
        v = a(739),
        h = n(v);
    f.default.plugin(h.default), window.PouchDB = f.default;
    var x = "post",
        g = void 0
}, function(e, t, a) {
    "use strict";
    ...
    function i(e) {
        e.on("requestGenerateIndex", function(e) {
            console.info("rssPlugin - requestGenerateIndex"), console.log("rssPlugin - requestGenerateIndex", e);
            ...
            n.forEach(function(e) { i.item({ title: e.title, description: e.html, url: "" + a + e.url, categories: e.tags, author: e.author.name, date: e.published_at }) });
            var o = i.xml(),
                r = [];
            return r.push({ name: "RSS", path: "rss/index.xml", content: o, message: "Publish rss feed" }), e.nextState.elementsToPublish = (e.nextState.elementsToPublish || []).concat(r), e
        })
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.rssPlugin = i;
    var o = a(754),
        s = n(o)
}, function(e, t, a) {
    "use strict";
    ...
    function i(e) {
        e.on("receiveAuthentication", function(e) { return console.info("SessionStorage Plugin - receiveAuthentication"), console.log("receiveAuthentication", e), e.nextState.isAuthenticated && sessionStorage.setItem(e.rootState.application.config.meta.repositoryName + "-authentication", (0, c.default)({ credentials: { token: e.nextState.credentials.token }, permissions: e.nextState.permissions, userInformations: e.nextState.userInformations })), e }), e.on("requestSavedAuth", function(e) {
            console.info("SessionStorage Plugin - requestSavedAuth"), console.log("requestSavedAuth", e);
            var t = void 0,
                a = sessionStorage.getItem(e.rootState.application.config.meta.repositoryName + "-authentication");
            return a ? (t = JSON.parse(a), t.isAuthenticated = !0) : t = { credentials: {}, userInformations: {}, isAuthenticated: !1 }, e.nextState.authentication = (0, s.default)({}, e.nextState.authentication, t), e
        }), e.on("requestLogout", function(e) { return console.info("SessionStorage Plugin - requestLogout"), console.log("requestLogout", e), sessionStorage.removeItem(e.rootState.application.config.meta.repositoryName + "-authentication"), e })
    }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var o = a(19),
        s = n(o),
    ...
    function i(e) {
        console.info("AuthorGenerator - generate"), console.log("AuthorGenerator - generate", e);
        var t = "author",
            a = void 0;
        if (!u.default.isTemplateAvailable(t)) return e;
        a = e.nextState.author ? e.nextState.publishedPosts.filter(function(t) { return t.author.login === e.nextState.author.login }) : e.nextState.publishedPosts;
        var n = c.default.reduce(a, function(e, t) { return e[t.author.login] = e[t.author.login] || [], e[t.author.login].push(t), e }, {}),
            i = e;
        return c.default.each(n, function(e, a) {
            var n = e[0].author;
            n.name = n.name || n.login, n.slug = a, n.website = n.blog, n.status = "", i = s.default.generate({ opts: i, posts: e, author: n, template: t, path: "author/" + a + "/" })
        }), i
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.generateAuthors = i;
    var o = a(58),
        s = n(o),
        r = a(4),
        c = n(r),
    ...
    function o() {
        var e, t, a = Array.prototype.slice.call(arguments),
            n = !1,
            i = d.paths.subdir.replace(/\//g, "");
        return "" === a[0] && a.shift(), 0 === a[0].indexOf("//") && (n = !0), t = a.join("/"), t = t.replace(/(^|[^:])\/\/+/g, "$1/"), n && (t = t.replace(/^\//, "//")), i && (e = new RegExp(i + "/" + i + "/"), t = t.replace(e, i + "/")), t
    }
    ...
    function r(e) {
        var t = "",
            ...
            n = { year: function() { return u(e.published_at).format("YYYY") }, month: function() { return u(e.published_at).format("MM") }, day: function() { return u(e.published_at).format("DD") }, author: function() { return e.author.slug }, slug: function() { return e.slug }, id: function() { return e.id } };
        return t += e.page ? "/:slug/" : a, t = t.replace(/(:[a-z]+)/g, function(e) { if (p.has(n, e.substr(1))) return n[e.substr(1)]() })
    }

    function c(e, t, a) {
        var n, r, c, l, u = "/",
            f = ["post", "tag", "author", "image", "nav"],
            v = { home: "/", rss: "/rss/", api: m, sitemap_xsl: "/sitemap.xsl" };
        if (p.isBoolean(t) && (a = t, t = null), n = e && e.secure || t && t.secure, p.isObject(e) && e.relativeUrl) u = e.relativeUrl;
    ...
    var u = a(2),
        ...
        d = "",
        m = "/ghost/api/v0.1";
    e.exports.setConfig = n, e.exports.urlJoin = o, e.exports.urlFor = c, e.exports.urlPathForPost = r, e.exports.apiUrl = l, e.exports.getBaseUrl = i
}, function(e, t, a) {
    "use strict";

    function n(e, t, a) { var n = ""; return n += e.match(/^favicon\.ico$/) ? i.url + "/" : i.activeTheme.url + "/", e.match(/^favicon\.ico$/) || e.match(/^shared/) || e.match(/^asset/) || (n += t ? "ghost/" : "assets/"), e = e.replace(/^\//, ""), a && (e = e.replace(/\.([^\.]*)$/, ".min.$1")), n += e, e.match(/^favicon\.ico$/) || (n = n + "?v=" + i.assetHash), n }
    var i = a(7);
    e.exports = n
}, function(e, t, a) {
    "use strict";
    ...
    function n(e, t) {
        var a = e.context,
            n = i.theme,
            o = e[a] || n;
        return "post" === a && o.author && o.author.image ? i.urlFor("image", { image: o.author.image }, t) : null
    }
    var i = a(7);
    e.exports = n
}, function(e, t, a) {
    ...
    function n(e, t) { var a = e.context; return e.author ? i.urlFor("author", { author: e.author }, t) : e[a] && e[a].author ? i.urlFor("author", { author: e[a].author }, t) : null }
    var i = a(7);
    e.exports = n
}, function(e, t, a) {
    "use strict";

    function n(e) { var t; return t = "author" === e.context ? e.author : "tag" === e.context ? e.tag : e, i.urlJoin(i.getBaseUrl(!1), o(t, !1)) }
    var i = a(7),
        o = a(74);
    e.exports = n
}, function(e, t, a) {
    ...
    function n(e) {
        var t = e.context,
            a = i.theme,
            n = e[t] || a;
        if ("home" === t || "author" === t) { if (n.cover) return i.urlFor("image", { image: n.cover }, !0) } else if (n.image) return i.urlFor("image", { image: n.image }, !0);
        return null
    }
    var i = a(7);
    e.exports = n
    ...
    function n(e, t) { var a, n; return e.relativeUrl && (a = e.relativeUrl.match(o), e.pagination && e.pagination.next) ? (n = "/page/" + e.pagination.next + "/", a ? n = a + n : s.test(e.relativeUrl) && (n = e.relativeUrl.slice(0, -1) + n), i.urlFor({ relativeUrl: n, secure: e.secure }, t)) : null }
    var i = a(7),
        o = /.+(?=\/page\/\d*\/)/,
        s = /\/(tag)|(author)\//;
    e.exports = n
    ...
    function n(e, t) { var a, n; return e.relativeUrl && (a = e.relativeUrl.match(o), e.pagination && e.pagination.prev) ? (n = e.pagination.prev > 1 ? "/page/" + e.pagination.prev + "/" : "/", n = a ? a + n : n, i.urlFor({ relativeUrl: n, secure: e.secure }, t)) : null }
    var i = a(7),
        o = /.+(?=\/page\/\d*\/)/;
    e.exports = n
}, function(e, t) {
    ...
    function n(e, t) { return i.urlFor("rss", { secure: e.secure }, t) }
    var i = a(7);
    e.exports = n
}, function(e, t, a) {
    "use strict";
    ...
    e.exports = { isPost: a, isTag: n, isUser: i, isNav: o }
}, function(e, t, a) {
    "use strict";
    var n = a(370);
    e.exports.checks = n
    ...
    function n(e, t) {
        var a = !1,
            n = !1;
        return new s.handlebars.SafeString(i(e, a, n))
    }
    var i = a(355),
        o = a(9),
        s = { handlebars: o };
    ...
    var n, i = a(9),
        ...
        c = a(47);
    n = function(e, t) {
        if (s.isUndefined(t) && (t = e), t.fn) return o.handlebars.helpers.with.call(this, this.author, t);
        var a = !s.isString(t.hash.autolink) || "false" !== t.hash.autolink,
            n = "";
        return this.author && this.author.name && (n = a ? c.linkTemplate({ url: r.urlFor("author", { author: this.author }), text: s.escape(this.author.name) }) : s.escape(this.author.name)), new o.handlebars.SafeString(n)
    }, e.exports = n
}, function(e, t, a) {
    "use strict";
    ...
    i = function(e) {
        var t, a = [],
            ...
            p = s.default.activeTheme.name;
        return i && a.push("post-template"), l.includes(n, "home") ? a.push("home-template") : l.includes(n, "page") && r ? (a.push("page-template"), a.push("page")) : l.includes(n, "tag") && this.tag ? (a.push("tag-template"), a.push("tag-" + this.tag.slug)) : l.includes(n, "author") && this.author ? (a.push("author-template"), a.push("author-" + this.author.slug)) : l.includes(n, "private") && a.push("private-template"), o && (a = a.concat(o.map(function(e) { return "tag-" + e.slug }))), l.includes(n, "paged") && (a.push("paged"), a.push("archive-template")), i && r && (t = u.single(p, i).split("-"), "page" === t[0] && t.length > 1 && (a.push(t.join("-")), t.splice(1, 0, "template"), a.push(t.join("-")))), a = l.reduce(a, function(e, t) { return e + " " + t }, ""), new c.handlebars.SafeString(a.trim())
    }, e.exports = i
}, function(e, t, a) {
    "use strict";
    var n, i = a(9),
        ...
        r = a(172),
        c = a(400);
    n = function(e) { var t = (e || {}).hash || {}; return t = s.pick(t, ["words", "characters"]), s.keys(t).map(function(e) { t[e] = parseInt(t[e], 10) }), t.hasOwnProperty("words") || t.hasOwnProperty("characters") ? t.hasOwnProperty("words") && 0 === t.words ? new o.handlebars.SafeString(c(this.html)) : new o.handlebars.SafeString(r(this.html, t)) : new o.handlebars.SafeString(this.html) }, e.exports = n
}, function(e, t, a) {
    "use strict";
    var n, i = a(2);
    n = function e(t, a) {
        !a && t.hasOwnProperty("hash") && (a = t, t = void 0, this.published_at && (t = this.published_at)), t = null === t ? void 0 : t;
        var e, n = a.hash.format || "MMM Do, YYYY",
            o = a.hash.timeago;
        return e = o ? i(t).fromNow() : i(t).format(n)
    }, e.exports = n
}, function(e, t, a) {
    "use strict";
    var n, i = a(9),
        o = { handlebars: i };
    n = function(e, t) { var a = e || t; return new o.handlebars.SafeString(encodeURIComponent(a)) }, e.exports = n
}, function(e, t, a) {
    "use strict";

    function n(e) { var t = (e || {}).hash || {}; return t = s.pick(t, ["words", "characters"]), s.keys(t).map(function(e) { t[e] = parseInt(t[e], 10) }), new o.handlebars.SafeString(r(String(this.html), t)) }
    var i = a(9),
        o = { handlebars: i },
        s = a(4),
        r = a(121);
    ...
    i = function(e, t) {
        ...
        t || console.error("Helpers foreach needs an iterator");
        var i, o, r = t.fn,
            p = t.inverse,
            d = t.hash.columns,
            m = l.size(e),
            ...
            x = "";
        return t.data && t.ids && (o = u.appendContextPath(t.data.contextPath, t.ids[0]) + "."), u.isFunction(e) && (e = e.call(this)), t.data && (i = c.handlebars.createFrame(t.data)), e && "object" === ("undefined" == typeof e ? "undefined" : (0, s.default)(e)) && n(e), 0 === m && (x = p(this)), x
    }, e.exports = i
}, function(e, t, a) {
    "use strict";
    ...
    n = function(e) {
        ...
        var a = o.reduce(t, function(e, t) { return e + " " + t }, "");
        return new i.SafeString(a.trim())
    }, e.exports = n
}, function(e, t, a) {
    "use strict";
    ...
    function s(e) {
        if (console.warn("Check ghost_head options", e, this.statusCode, this.context), !(this.statusCode >= 400)) {
            var t = l(this, e.data.root),
                a = [],
    ...
    n = function(e, t) {
        ...
        t = t || {};
        var n = t.data.root.context;
        return i.isString(e) || console.warn("Helpers is has an invalid attribute"), a(e) ? t.fn(this) : t.inverse(this)
    }, e.exports = n
}, function(e, t, a) {
    "use strict";

    function n(e) { return e = e || { data: {} }, i(this, e.data.root) || "" }
    var i = a(120);
    e.exports = n
}, function(e, t, a) {
    "use strict";
    ...
    n = function(e) {
        var t = ["post"],
            ...
            i = this.post && this.post.page ? this.post.page : this.page || !1;
        return a && (t = t.concat(a.map(function(e) { return "tag-" + e.slug }))), n && t.push("featured"), i && t.push("page"), t = s.reduce(t, function(e, t) { return e + " " + t }, ""), new o.handlebars.SafeString(t.trim())
    }, e.exports = n
}, function(e, t, a) {
    "use strict";
    var n, i = a(9),
    ...
    n = function(e) {
        ...
        e = e || {}, e.hash = e.hash || {};
        var a = !(s.isString(e.hash.autolink) && "false" === e.hash.autolink),
            ...
            m = "";
        return this.tags && this.tags.length && (m = t(this.tags), p -= 1, d = d || u + p || this.tags.length, m = i + m.slice(p, d).join(n) + l), new o.handlebars.SafeString(m)
    }, e.exports = n
}, function(e, t, a) {
    "use strict";
    var n, i = a(9),
        o = { handlebars: i };
    n = function() { return new o.handlebars.SafeString(o.handlebars.Utils.escapeExpression(this.title || "")) }, e.exports = n
}, function(e, t, a) {
    "use strict";

    function n(e) { var t = e && e.hash.absolute; return i(this, t) }
    var i = a(74);
    e.exports = n
}, function(e, t, a) {
    "use strict";
    ...
    function i(e, t) {
        var a = l.default.defer(),
            n = [],
            i = t.urls.hubpress;
        return p.default.get(i + "/themes/" + e + "/theme.json?dt=" + Date.now()).end(function(t, o) {
            if (t) return void a.reject(t);
            var s = o.body,
                r = s.version,
            ...
            if (c.forEach(function(t) {
                    var a = l.default.defer();
                    n.push(a.promise), u = u || "pagination" === t[0], d = d || "nav" === t[0], f = f || "navigation" === t[0], p.default.get(i + "/themes/" + e + "/" + t[1] + "?v=" + r).end(function(e, n) { return e ? void a.reject(e) : void a.resolve({ name: t[0], path: t[1], content: n.text }) })
                }), !u) {
                var v = l.default.defer();
                n.push(v.promise), p.default.get(i + "/hubpress/scripts/helpers/tpl/pagination.hbs").end(function(e, t) { return e ? void v.reject(e) : void v.resolve({ name: "pagination", path: "partials/pagination", content: t.text }) })
            }
            if (!d) {
                var h = l.default.defer();
                n.push(h.promise), p.default.get(i + "/hubpress/scripts/helpers/tpl/nav.hbs").end(function(e, t) { return e ? void h.reject(e) : void h.resolve({ name: "nav", path: "partials/nav", content: t.text }) })
            }
            if (!f) {
                var x = l.default.defer();
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.generateIndex = i;
    var o = a(58),
        s = n(o)
}, function(e, t, a) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.generatePosts = i;
    var o = a(58),
        s = (n(o), a(34)),
        r = (n(s), a(125))
}, function(e, t, a) {
    ...
    function i(e) {
        console.info("TagsGenerator - generate"), console.log("TagsGenerator - generate", e);
        var t = "tag",
            a = void 0;
        if (!u.default.isTemplateAvailable(t)) return e;
        if (e.nextState.post && !e.nextState.post.tags && !e.nextState.tags) return e;
        a = e.nextState.tags ? e.nextState.publishedPosts.filter(function(t) {
            var a = e.nextState.tags.map(function(e) { return e.trim() }),
                n = (t.tags || []).map(function(e) { return e.trim() });
            return c.default.intersection(a, n).length
        }) : e.nextState.publishedPosts;
        var n = c.default.reduce(a, function(t, a) { if (!a.tags) return t; var n = c.default.reduce(a.tags, function(t, a) { var n = (0, d.default)(a); return e.nextState.post && e.nextState.post.tags && e.nextState.post.tags.indexOf(a) === -1 || t.push(n), t }, []); return c.default.uniq(n).forEach(function(e) { t[e] = t[e] || [], t[e].push(a) }), t }, {}),
            i = e;
        return c.default.each(n, function(e, a) {
            var n = { name: a, slug: (0, d.default)(a), description: null };
            i = s.default.generate({ opts: i, posts: e, tag: n, template: t, path: "tag/" + a + "/" })
        }), i
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.generateTags = i;
    var o = a(58),
        s = n(o),
        r = a(4),
        c = n(r),
    ...
    function i(e) {
        for (o = [], s = "", r = "", c = "", l = 0, u = 0; u < e.length; u += 1) {
            switch (l !== p.unitialized && (r += e[u]), e[u]) {
                case "<":
                    l === p.unitialized && e[u + 1].match(/[a-z0-9\-\_\/\!]/) && (l = p.tag_commenced, r += e[u]);
                    break;
                case "!":
                    l === p.tag_commenced && "<" === e[u - 1] && (l = p.comment);
                    break;
                case '"':
                    if (l === p.tag_string) l = p.tag_commenced;
                    else {
                        if (l === p.tag_string_single) break;
                        l !== p.unitialized && (l = p.tag_string)
                    }
                    break;
                case "'":
                    if (l === p.tag_string_single) l = p.tag_commenced;
                    else {
                        if (l === p.tag_string) break;
                        l !== p.unitialized && (l = p.tag_string_single)
                    }
                    break;
                case ">":
                    if (l === p.tag_commenced) { l = p.unitialized, c += r, s = a(r), r.match(/<\s*\//) && a(o[o.length - 1]) === s ? o.pop() : d.indexOf(s) < 0 && !r.match(/\/\s*>$/) && o.push(r), r = ""; continue }
                    if (l === p.comment && "--" === e.substring(u - 2, u)) { l = p.unitialized, c += r, r = ""; continue }
                    break;
                case "-":
            }
            if (!l) break
        }
        for (c += r; o.length;) c += n(o.pop());
        return c
    }
    var o, s, r, c, l, u, p = { unitialized: 0, tag_commenced: 1, tag_string: -1, tag_string_single: -2, comment: -3 },
    ...
    t.default = {
        initStores: function() {
            var e = { rootState: l.default.cloneDeep(p), currentState: l.default.cloneDeep(p) };
            return (0, u.initializeStores)(e).then(function(e) {
                l.default.merge(p, e.nextState);
                var t = { state: p, actions: d, mutations: m, modules: e.nextState.stores },
                    a = new r.default.Store(t);
                return a
            })
        }
    }
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.initializeStores = i;
    var o = a(52),
        s = n(o)
}, function(e, t, a) {
    "use strict";
    ...
    a(640), a(637), a(458), t.default = {
        ...
        props: { hint: Boolean, code: String, value: String, unseenLines: Array, marker: Function, options: { type: Object, default: function() { return { styleActiveLine: !0, lineNumbers: !0, mode: "text/javascript", lineWrapping: !0 } } } },
        created: function() {
            this.options = this.options || {};
            var e = this.options.mode || "text/javascript",
                t = this.options.theme,
                n = this.hint || !1,
                i = ["css", "html", "javascript", "sql", "xml"];
            if ("string" == typeof e) {
                var s = r.findModeByMIME(e);
                e = s ? s.mode : s
        ...
        ready: function() {
            var e = this;
            this.editor = s.fromTextArea(this.$el, this.options), this.editor.setValue(this.code || this.value || this.content), this.editor.on("change", function(t) { e.content = t.getValue(), e.code = t.getValue() })
        },
        mounted: function() {
            var e = this;
            this.editor = s.fromTextArea(this.$el, this.options), this.editor.setValue(this.code || this.value || this.content), this.editor.on("change", function(t) { e.content = t.getValue(), e.$emit && (e.$emit("changed", e.content), e.$emit("input", e.content)) }), this.unseenLineMarkers()
        },
        watch: {
            code: function(e, t) {
        ...
        methods: {
            unseenLineMarkers: function() {
                var e = this;
                void 0 !== e.unseenLines && void 0 !== e.marker && e.unseenLines.forEach(function(t) {
                    var a = e.editor.lineInfo(t);
                    e.editor.setGutterMarker(t, "breakpoints", a.gutterMarkers ? null : e.marker())
                })
            }
        }
    }
    ...
    t.default = {
        name: "app",
        components: { Navigation: o.default, MenuButton: r.default, MainContainer: l.default },
        mounted: function() {
            var e = this;
            this.$store.watch(function(e) { return e.application.notification.isVisible }, function(t, a) {
                if (t) {
    ...
    t.default = {
        ...
        methods: {
            toggleNavigation: function() {
                (0, o.default)(".ui.sidebar").sidebar("toggle")
            }
        }
    }
}, function(e, t, a) {
    ...
    t.default = {
        name: "navigation",
        mounted: function() {
            (0, o.default)("#app .ui.sidebar").sidebar({ context: (0, o.default)("#app") }).sidebar("setting", "transition", "overlay")
        },
        methods: {
            toggleMenu: function() {
                (0, o.default)(".ui.sidebar").sidebar("toggle")
        ...
        computed: { navigations: function() { return this.$store.getters.navigations }, currentUser: function() { return this.$store.state.authentication.userInformations }, hubpressVersion: function() { return "0.8.1" }, upgrade: function() { return "https://github.com/" + this.$store.state.application.config.meta.username + "/" + this.$store.state.application.config.meta.repositoryName + "/compare/" + this.$store.state.application.config.meta.branch + "...HubPress:" + this.$store.state.application.config.meta.branch } }
    }
}, function(e, t, a) {
    "use strict";
    ...
    t.default = {
        ...
        beforeCreate: function() {
            var e = this;
            this.$store.state.application.settingsTabs.forEach(function(t) { e.$options.components[t.id] = t.component })
        },
        mounted: function() {
            (0, o.default)(".settings-content .menu .item").tab()
        },
        methods: {
            submit: function() {
                var e = new FormData(document.getElementById("mainForm"));
                this.$store.dispatch(s.constants.APPLICATION_PREPARE_CONFIG, e)
            }
        },
        computed: { tabs: function() { return this.$store.state.application.settingsTabs.sort(function(e) { return e.label }) }, config: function() { return this.$store.state.application.config || { meta: {} } } }
    }
}, function(e, t, a) {
    "use strict";
    ...
    t.default = {
        name: "posts",
        data: function() { return { content: void 0, timeout: void 0, isDark: !0, isPreviewVisible: !1, editorOption: { tabSize: 4, mode: "asciidoc", theme: "zenburn", lineNumbers: !1, line: !0, lineWrapping: !0, fixedGutter: !0, keyMap: "sublime", extraKeys: { Ctrl: "autocomplete" }, foldGutter: !0, gutters: ["CodeMirror-linenumbers"], styleSelectedText: !0, highlightSelectionMatches: { showToken: /\w/, annotateScrollbar: !0 } } } },
        methods: {
            contentChange: function(e) {
                var t = this;
                if (this.post.content !== e) {
                    var a = this.$store.state.application.config.meta.delay ? this.$store.state.application.config.meta.delay : 200;
                    this.timeout && window.clearTimeout(this.timeout), this.timeout = window.setTimeout(function() { t.$store.dispatch(c.POST_CHANGE_CONTENT, { _id: t.post._id, content: e }) }, a ? a : 200)
                }
            },
            showAsciidocHelp: function() { $("#asciidoc-help").modal("show") },
            switchLight: function() { this.isDark = !this.isDark, this.$refs.codeEditor.editor.setOption("theme", this.isDark ? "zenburn" : "base16-light") },
            switchPreview: function() { this.isPreviewVisible = !this.isPreviewVisible },
            remoteSave: function() { this.post.published ? this.$store.dispatch(c.POST_PUBLISH, this.post._id) : this.$store.dispatch(c.POST_REMOTE_SAVE, this.post._id) },
            publish: function() { this.post.published ? this.$store.dispatch(c.POST_UNPUBLISH, this.post._id) : this.$store.dispatch(c.POST_PUBLISH, this.post._id) },
            unpublish: function() { this.$store.dispatch(c.POST_UNPUBLISH, this.post._id) }
        },
        beforeMount: function() { this.$store.dispatch(c.POST_GET, this.$route.params.id) },
        mounted: function() { $(".ui.dropdown.item.themes").dropdown(), $("#asciidoc-help").modal({ closable: !0 }) },
        beforeUpdate: function() { this.content || (this.content = this.post.content) },
        computed: { id: function() { return this.$route.params.id }, post: function() { return this.$store.state.hubpress.post }, previewLabel: function() { return this.isPreviewVisible ? "Hide preview" : "Show preview" }, lightLabel: function() { return this.isDark ? "Light mode" : "Dark mode" }, publishLabel: function() { return this.$store.state.hubpress.post.published ? "Unpublish post" : "Publish post" }, isRemoteActionVisible: function() { return !!this.$store.state.hubpress.post.title } },
        beforeCreate: function() {},
        created: function() {},
        components: { Preview: r.default }
    }
}, function(e, t, a) {
    "use strict";
    ...
    t.default = {
        name: "posts",
        data: function() { return { postToDelete: {}, filterValue: "" } },
        beforeCreate: function() {},
        beforeMount: function() { this.$store.dispatch(c.POSTS_GET) },
        beforeDestroy: function() { $(".ui.basic.modal").remove() },
        mounted: function() {
            var e = this;
            $(".ui.basic.modal").modal({ closable: !1, onDeny: function() {}, onApprove: function() { e.$store.dispatch(c.POST_DELETE, e.postToDelete._id) } })
        },
        methods: { status: function(e) { return !!e.published && "Published" || "Draft" }, publishedAt: function(e) { return !!e.published && (0, o.default)(e.published_at).fromNow() || "" }, postCoverUrl: function(e) { var t = e.image || "https://hubpress.io/img/logo.png"; return t = t.startsWith("https") ? t : e.attributes.$$smap.imagesdir + "/" + e.image }, getPostStatusColor: function(e) { return e.original ? e.original.content !== e.content ? "orange" : "green" : "red" }, displayConfirmMessage: function(e) { this.postToDelete = e, $(".ui.basic.modal").modal("show") }, navigateToPost: function(e) { this.$router.push({ name: "post", params: { id: e._id } }) }, newPost: function() { this.$router.push({ name: "post", params: { id: r.default.v4() } }) }, getPostTags: function(e) { return e.tags || [] }, getPostAuthor: function(e) { return e.author || this.$store.state.authentication.userInformations }, synchronize: function() { this.$store.dispatch(c.POSTS_SYNCHRONIZE) } },
        computed: { posts: function() { var e = this.filterValue.trim(); return "" === e ? this.$store.state.hubpress.posts : this.$store.state.hubpress.posts.filter(function(t) { return t.title.toLowerCase().indexOf(e.toLowerCase()) >= 0 || t.tags && t.tags.filter(function(t) { return t.toLowerCase().indexOf(e.toLowerCase()) >= 0 }).length }) } }
    }
    ...
    function applyScript(hasChanged) {
        if (hasChanged) {
            for (var element = document.getElementById("html-rendering"), scripts = element.getElementsByTagName("script"), addedScripts = [], i = 0; i < scripts.length; i++)
                if ("" != scripts[i].src && addedScripts.indexOf(scripts[i].src) === -1) {
                    var tag = document.createElement("script");
                    tag.src = scripts[i].src, addedScripts.push(tag.src), document.getElementsByTagName("head")[0].appendChild(tag)
    ...
    Object.defineProperty(exports, "__esModule", { value: !0 }), exports.default = { name: "preview", props: ["post"], mounted: function() { applyScript(this.post.content && this.post.content.trim().length) }, updated: function(e, t) { applyScript(!0) } }
}, function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = { name: "hubpress-settings", computed: { meta: function() { return this.$store.state.application.config.meta || {} }, site: function() { return this.$store.state.application.config.site || {} }, theme: function() { return this.$store.state.application.config.theme || {} } } }
}, function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = { name: "hubpress-settings-social", computed: { social: function() { return this.$store.state.application.config.socialnetwork || {} } } }
}, function(e, t, a) {
    "use strict";
    ...
    t.default = {
        ...
        data: function() { return { username: "", repositoryName: "hubpress.io", branch: "master", cname: void 0 } },
        mounted: function() {
            (0, o.default)("div.dropdown").dropdown()
        },
        computed: { isValid: function() { return "" != this.username.trim() && "" != this.repositoryName.trim() } },
        methods: {
            submit: function() {
                var e = { username: this.username, repositoryName: this.repositoryName, branch: this.branch, cname: this.cname };
                this.$store.dispatch(s, e)
            }
        }
    }
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(e, t, a) {
    ...
    var o = { "./anyword-hint.js": 467, "./css-hint.js": 468, "./html-hint.js": 469, "./javascript-hint.js": 470, "./show-hint.js": 142, "./sql-hint.js": 471, "./xml-hint.js": 143 };
    n.keys = function() { return Object.keys(o) }, n.resolve = i, e.exports = n, n.id = 466
}, , , , , , , , , , function(e, t, a) {
    function n(e) { return a(i(e)) }
    ...
    e.exports = {
        ...
        staticRenderFns: [function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "ui icon", attrs: { "data-tooltip": "Save your settings", "data-position": "bottom right" } }, [a("i", { staticClass: "save large icon" })])
        }, function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("h2", { staticClass: "ui center aligned icon header" }, [a("i", { staticClass: "circular settings icon" }), e._v("\n      Settings\n    ")])
        }, function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "disabled field" }, [a("label", [e._v("Blog URL")]), e._v(" "), a("input", { attrs: { type: "text", disabled: "", name: "application-blog-url", placeholder: "Blog URL" } })])
        }]
    }
}, function(e, t) {
    e.exports = {
        render: function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "ui black launch right attached fixed button", attrs: { id: "menu-button" }, on: { click: e.toggleNavigation } }, [a("i", { staticClass: "content large icon" })])
        },
        staticRenderFns: []
    }
}, function(e, t) {
    ...
    e.exports = {
        render: function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "pusher" }, [a("router-view")], 1)
        },
        staticRenderFns: []
    }
}, function(e, t) {
    e.exports = {
        ...
        staticRenderFns: [function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "ui icon", attrs: { "data-tooltip": "Synchronize content", "data-position": "bottom right" } }, [a("i", { staticClass: "refresh large icon" })])
        }, function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "ui icon", attrs: { "data-tooltip": "Create a post", "data-position": "bottom right" } }, [a("i", { staticClass: "add large icon" })])
        }, function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "content" }, [a("p", [e._v("Are you sure you want to delete this post?")])])
        }, function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", { staticClass: "actions" }, [a("div", { staticClass: "ui red basic cancel inverted button" }, [a("i", { staticClass: "remove icon" }), e._v(" No\n            ")]), e._v(" "), a("div", { staticClass: "ui green ok inverted button" }, [a("i", { staticClass: "checkmark icon" }), e._v(" Yes\n            ")])])
        }]
    }
}, function(e, t) {
    e.exports = {
        render: function() {
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("div", {}, [a("h1", { staticClass: "ui header" }, [e._v(e._s(e.post.title))]), e._v(" "), a("div", { attrs: { id: "html-rendering" }, domProps: { innerHTML: e._s(e.post.html) } })])
        },
        staticRenderFns: []
    }
}, function(e, t) {
    ...
    e.exports = {
        ...
        staticRenderFns: [function() {
            ...
            var e = this,
                t = e.$createElement,
                a = e._self._c || t;
            return a("a", { staticClass: "item", attrs: { href: "https://github.com/orgs/HubPress/people", target: "_blank" } }, [e._v("Contributors"), a("i", { staticClass: "heart icon" })])
        }]
    }
}, function(e, t) {
    e.exports = {
